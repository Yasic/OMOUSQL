...
import com.yasic.omousql.View.TencentNewsView;
 ...
 */
public class TencentNewsPresenter extends BasePresenterFragment<TencentNewsView> {
    ...
    protected void onBindBVI() {
        ...
        getNews("http://news.qq.com/world_index.shtml");
    }
    ...
    @Override
    protected Class<TencentNewsView> getBVIClass() {
        return TencentNewsView.class;
    }
}
